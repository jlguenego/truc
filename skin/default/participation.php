...
?>
		<tr>
			...
			<td><button id="add_btn_<?php echo $ticket->id; ?>" OnClick="add_ticket(<?php
				...
				?>);return false;" <?php echo $disable; ?>>{{Add}}</button></td>
		</tr>
<?php
			}
			arsort($tax_array);
...
?>
	...
	<table class="evt_table inline">
		...
		<tr>
			...
			<td>
				<input id="<?php echo $i; ?>_amount" type="number" min="0" max="<?php echo $remaining; ?>" name="ticket_<?php echo $i; ?>" value="<?php echo_default_value("ticket_${i}", 0); ?>" data-id="<?php echo $i; ?>" data-type="quantity"/><br/>
