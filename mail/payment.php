<?php
	function mail_html_payment($devis, $event) {
		ob_start();
		include("header.php");
?>
		<p>
			...
			<?php echo $event->title; ?> has been authorized.<br/>
		...
		?>
			...
			<br/>
			Please make sure that the amount of <b><?php echo curr($devis->total_ttc); ?>€</b> will be avalable for at least 29 days.<br/>
		</p>
<?php
		include("footer.php");
